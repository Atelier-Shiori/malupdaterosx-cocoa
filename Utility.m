...
+(void)showDonateReminder{
    ...
    if ([[[NSUserDefaults standardUserDefaults] objectForKey:@"donatereminderdate"] timeIntervalSinceNow] < 0 && ![[NSUserDefaults standardUserDefaults] boolForKey: @"donateremindersuppress"]) {
        ...
        [alert setInformativeText:@"We noticed that you have been using MAL Updater OS X for a while. Although MAL Updater OS X is free, it cost us money and time to develop this program and keep the Unofficial MAL API running. \r\rIf you find this program helpful, please consider making a donation. Funding will help future development and keep the program functional. Note that donating is completely optional."];
