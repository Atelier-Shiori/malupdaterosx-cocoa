...
XCode 9 or higher is required to build (Deployment Target is OS X 10.10)
...
Like this program and want to support the development of this program? Purchase a [Donation License](https://malupdaterosx.ateliershiori.moe/donate/). This allows us to help cover the costs of developing this program and unlock Pro features that will be implemented in the future such as bittorrent downloading and episode tracking (ability to scan anime video files and play next episodes in your favorite video player automatically).
